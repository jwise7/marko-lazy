const DEFAULT_PREFETCH_ROOT_MARGIN = "1200px 0px";
const DEFAULT_RENDER_ROOT_MARGIN = "600px 0px";
const DEFAULT_PREFETCH_BUFFER = 1200;
const DEFAULT_RENDER_BUFFER = 600;
